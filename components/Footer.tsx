          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 md:flex-1">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/terms" className="text-charcoal hover:text-gold transition-colors">Terms &amp; Conditions</Link></li>
              </ul>
            </div>
          </div>
        </div>
        <div className="mt-10 pt-8 border-t border-sand">
          <SocialIcons enabled={['facebook', 'pinterest', 'youtube', 'tiktok']} />
        </div>
