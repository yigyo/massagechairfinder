...
export const LOCAL_BRANDS: LocalBrand[] = [
...

  {
    ...
    seoDescription: "Kahuna offers SL-track massage chairs from $2,000 to $16,999. Here is what to expect from the HM-5000 at entry level through the Dios premium line and who each chair suits best."0 and LM-6800S, and who these chairs are right for.",
    description: [
...

  {
    slug: "ogawa",
    name: "Ogawa",
    tagline: "A Malaysian brand with strong feature density at each price point, from $3,000 to $15,999.",
