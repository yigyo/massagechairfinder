...
export const LOCAL_BRANDS: LocalBrand[] = [
...

  {
    slug: "bodyfriend",
    name: "Bodyfriend",
    tagline: "Korean luxury massage chairs with medical-grade positioning and high-end aesthetics, starting at $8,100.",
    ...
    description: [
      ...
      "<p>The Phantom Medical Care 4D SL at $11,000 is their flagship and carries medical-grade certification for certain therapeutic applications. The Phantom II and Falcon XD are both priced at $8,499 and represent the core of the lineup. All four models use 4D roller technology and SL-track coverage. The Phantom II at $8,100 and the Falcon XD at $8,499 are the core of the accessible lineup.</p>",
...

  {
    ...
    description: [
      "<p>Kyota is a brand that shares US distribution infrastructure with Osaki, which means parts availability and service support is comparable. The current catalog includes two chairs: the Genki M380 at $2,999 and the Yugana M780 at $7,999.upport are more reliable than many smaller names at this price tier. The Genki M380 at $2,999 is the current Kyota model in our catalog, positioned as an accessible entry point for buyers who have confirmed they want a massage chair but are not yet ready to commit to the $4,000 to $6,000 range.</p>",
...

  {
    slug: "relax-on-chair",
    name: "Relax On Chair",
    tagline: "A value-focused brand with entry-to-premium chairs from $1,599 to $6,499, covering L-track, SL-track, 3D, and 4D roller options.",
    priceRange: "$1,599 to $6,499",
...

  {
    ...
    description: [
      ...
      "<p>The Solara at $2,499 is a more accessible entry point for buyers who are drawn to the brand's philosophy but not yet ready to spend $8,000. It uses a different roller and track configuration than the Brio line, so buyers should evaluate it independently rather than as a scaled-down version of the flagship.</p>",
