...
export const LOCAL_BRANDS: LocalBrand[] = [
...

  {
    ...
    description: [
      "<p>JPMedics is a Japanese brand targeting the upper end of the US market with two models: the Kumo 4D (premium tier) and the KaZe Duo ($12,000 and up). Both use 4D roller mechanisms with body scanning systems calibrated to a higher level of precision than most chairs at their price points. The distinguishing characteristic of JPMedics chairs in practice is how quiet they are during operation, which matters more than buyers typically expect at the point of purchase. A chair used daily in a shared living space benefits significantly from lower operating noise.</p>",
