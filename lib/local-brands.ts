...
export const LOCAL_BRANDS: LocalBrand[] = [
...

  {
    slug: "kahuna",
    name: "Kahuna",
    tagline: "SL-track chairs from $2,000 to $16,999, spanning an entry-level HM series through a premium Dios line with 6D, 7D, and 8D roller technology.",
    ...
    bestFor: "Buyers across a wide price range who want SL-track coverage. The HM-078 at $4,399 is one of the few mid-range chairs confirmed at 350-lb capacity. The Dios line is the right path for buyers who want escalating roller precision from 6D through 8D.",
    seoTitle: "Kahuna Massage Chairs: Brand Overview and Buying Guide",
    seoDescription: "Kahuna offers SL-track massage chairs from $2,000 to $16,999. Here is what to know about the HM series at entry and mid range, the Dios line at upper-mid and premium, and which chair fits your budget and body.",
    description: [
      "<p>Kahuna's active lineup runs from the $2,000 HM-5000 through the $16,999 Dios-1288 8D, covering more price tiers than most SL-track competitors. The entire active catalog uses SL-track coverage, which follows the spine from the neck through the glutes and outperforms S-track for buyers whose pain includes the lower back and hips. The lineup splits into two product families: the HM series handles entry through mid range, and the Dios line handles upper-mid through premium with progressively higher roller dimensionality.</p>",
      "<p>The HM-5000 at $2,000 is the entry point: SL-track, 2D roller, space-saving design, zero gravity, foot and calf massage, and a 290-lb capacity confirmed for buyers up to 6 feet 2 inches. The step-up is the HM-078 Hubot 4D at $4,399, which adds 4D roller technology, voice control, and a 350-lb weight capacity, the highest confirmed capacity of any Kahuna chair in the current catalog. Buyers who are near or above 300 lbs and want a mid-range SL-track option have limited choices at this price, and the HM-078 is one of the clearest fits. The SM-7300S at $6,999 also targets larger buyers with a six-roller system and heat to the lumbar, calf, and feet, though its roller technology is 2D rather than 4D.</p>",
      "<p>The Dios line starts at $3,799 with the Dios-6800 6D and steps through the Dios-7300 7D at $7,999, the Dios Flexa at $8,499, and the Dios-1288 8D at $16,999. The naming convention reflects roller dimensionality: 6D, 7D, and 8D systems add progressively more motor-controlled movement axes beyond standard 4D. For buyers whose primary concern is roller precision and intensity control, the Dios line gives a clear upgrade path. The EM-8500 at $8,900 and HM-KAPPA at $9,500 round out the upper-mid range with 4D rollers, heat to the lumbar and legs, and dual foot and calf roller systems. Buyers comparing Kahuna in this tier against Kyota and Osaki should evaluate track length and roller technology side by side, as differences in SL-track length affect coverage for taller buyers.</p>",
    ],
  },
...

  {
    ...
    description: [
      ...
      "<p>The Hilux 4D at $4,999 is a more capable chair. It uses a 4D roller mechanism on an SL-track, which puts it in the same 4D SL-track configuration tier as competing chairs from Kahuna and Kyota in the $4,000 to $5,000 range. Buyers comparing options at this price point should focus on body scanning accuracy and roller feel as the meaningful differentiators.</p>",
...

  {
    ...
    description: [
      ...
      "<p>Ador is currently a single-model brand in our catalog, which limits the range of buyer profiles it can serve. If your budget is firmly at $4,999 and you want an SL-track chair with Osaki's support network, the 3D Allure is a reasonable option. If 4D rollers are important, compare the AmaMedics Hilux 4D and the Kahuna Dios-6800 directly before deciding.</p>",
    ],
  },
