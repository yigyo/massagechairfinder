...
export const LOCAL_BRANDS: LocalBrand[] = [
...

  {
    ...
    description: [
      "<p>Kyota is a brand that shares US distribution infrastructure with Osaki, which means parts availability and service support is comparable. The current catalog includes two chairs: the Genki M380 ($5,000-$7,999) and the Yugana M780 ($5,000-$7,999). Parts availability and service support are more reliable than many smaller names at this price tier. The Genki M380 spent a long stretch discounted into the entry tier, but that promotion has ended and it now sells at full list price alongside the Yugana.</p>",
