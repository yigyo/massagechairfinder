...
export const CHAIRS: Chair[] = [
...

  {
    ...
    brand: 'OHCO',
    active: true, goodwinActive: false, mcfActive: true,
    priceMin: 8499, priceEstimated: true,
    affiliateTier: null,
    affiliateRetailer: 'johnsonfitness.com',
    affiliateUrl: 'https://www.johnsonfitness.com/massage-chairs/ohco-m8-neo-le',
    track: 'SL', roller: '4D',
    zeroGravity: true, heat: true, aiScanning: true,
    aiNotes: 'Price estimated ~$8,499 (johnsonfitness.com blocked during data fetch -- verify before recommending). SL-Track 4D. Dual zero gravity. Body scan. Sold exclusively through Johnson Fitness.',
  },
