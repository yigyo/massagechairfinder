...
const EDITORIAL: Record<string, Editorial> = {
  "kyota-genki-m380": {
    ...
    why: "The Genki M380 is one of the most forgiving chairs in the catalog to operate. L-track covers the lower back, glutes, and upper thighs, which is where most chronic pain accumulates in older buyers. The 330-lb weight capacity is among the highest on this list, and the zero gravity position takes pressure off the lumbar during the session. It delivers the fundamentals without complex programs or settings. Its price has moved between the entry and upper-mid bands with retailer promotions through 2026, so check the current band badge.",
  },
  "inner-balance-jin-2": {
  ...
  return (
    <div className="section">
      ...
      <div className="bg-white border border-sand rounded-xl p-6 mb-10 max-w-2xl">
        ...
        <p className="text-charcoal leading-relaxed mb-3">
          If the main concern is chronic lower back or hip pain, the Genki M380 (entry to upper-mid, depending on the current promotion), Medical Breakthrough 6 (mid-range), or Kyota Yugana M780 (upper-mid) are all L-track chairs that cover the glutes. Any of the SL-track picks also cover that range. If the pain is primarily upper back and neck, any chair on this list works.
        </p>
        <p className="text-charcoal leading-relaxed mb-3">
