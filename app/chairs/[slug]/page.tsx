...
function verdictSummary(chair: Chair): string {
  const verdicts: Record<string, string> = {
    ...
    'kyota-genki-m380': `The Kyota Genki M380 is a high-capacity L-track value pick, confirmed for buyers up to 6'5" and 330 lbs at $2,999. Track type is unconfirmed. Verify with the retailer before purchasing based on pain location.`,
