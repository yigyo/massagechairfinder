  ...
  switch (chair.track) {
    case 'SL':
      return {
        ...
        body: `The ${chair.name} uses an SL-track, which follows the full curve of your spine from the base of the neck through the lower back and under the glutes. This is the right track type for buyers with lower back pain that radiates into the hips. The roller path reaches the sacral area and upper hamstrings that S-track and many L-track chairs miss. If lower back and hip tension is your primary concern, an SL-track chair is almost always the right call.`,
      }
    case 'L':
      return {
...
function bodyFitSummary(chair: Chair): string {
  ...
  if (chair.petiteConfirmed) {
    parts.push(`Confirmed to fit users at 5'0". This is one of the few chairs in this category with a confirmed petite lower bound.`)
  }
...
function verdictSummary(chair: Chair): string {
  const verdicts: Record<string, string> = {
    'osaki-os-champ': `The OS-Champ earns its place in the catalog as one of the few entry-level chairs with an SL-track and 3D roller, specs that usually appear a price tier higher. The tradeoff is a lighter build and fewer feature options. For a first-time buyer who wants SL-track coverage without the mid-range price commitment, it is a reasonable starting point.`,
    'osaki-os-pro-yamato': `The Yamato's standout feature is its value-to-feature ratio: stretch programs, heat, foot rollers, and calf compression in an entry-tier L-track chair. The 2D roller and 220 lb weight limit are real constraints. For buyers in the right size range who want a feature-rich entry chair, it consistently earns its recommendation.`,
    'osaki-os-pro-admiral-ii': `The OS-Pro Admiral II is one of the most well-rounded chairs in its price range. You get a 3D SL-track, body scanning, zero gravity, heat, and foot rollers in a space-saving frame that clears the wall in just 2". For buyers with both upper-back and lower-back tension, this chair is a consistent first recommendation.`,
    'osaki-os-pro-maestro-le': `The Maestro LE 2.0 is Osaki's step-up 4D SL-track offering, and the jump from the Admiral II to this chair is a real one in feel. If the Admiral II's 3D roller feels too light after a trial, the Maestro LE is the natural next look. The wide price range reflects frequent promotions. At the lower end it is strong value.`,
    'osaki-os-pro-4d-duomax': `The DuoMax uses a dual 4D roller mechanism, using two independent roller sets running simultaneously, which is rare in this category. It is a premium investment, best suited for buyers who have already owned a quality massage chair and are looking for something significantly more capable. White glove delivery is included.`,
    'kahuna-lm-6800': `The Kahuna LM-6800 was one of the best-selling entry massage chairs of its era: an L-track that follows the spine from the neck through the glutes, a confirmed 2D roller, two-stage zero gravity, stretch programs, and heat. Kahuna retired the LM-6800 in 2026, so it is no longer in production. The closest current stand-in in our catalog is the Kyota Genki M380, which holds the entry-tier L-track position with an updated roller. If you are cross-shopping Kahuna's own current lineup instead, the Dios-6800 6D is the nearest step up.`,
    'kahuna-lm-6800s': `The LM-6800S shares the LM-6800's L-to-SL upgrade track and three-stage zero gravity, adding a few refinements. It sits at a similar price to its sibling. The choice between them typically comes down to exact feature differences. Compare both before deciding.`,
    ...
    'infinity-celebrity': `The Celebrity 3D/4D, formerly sold as the Riage X3, is an L-track chair with a 4D roller. Confirmed 4'6" to 6'4" height range, 300 lb capacity, heat, and foot massage. Affiliate retailer currently being confirmed -- check massagechairstore.com for current availability.`,
    'infinity-evolution': `The Evo Max 4D delivers a 4D L-track with 49" track length, stretch programs, heat, and a space-saving design with just 2" wall clearance. For buyers focused on lower back and hip relief, it is a strong contender.`,
    'infinity-genesis-max': `The Genesis Max 4D shares the Evo Max's 4D L-track, 49" track, and stretch programs at a lower price, a meaningful difference for a comparable feature set. Worth comparing the two directly if you are in this range.`,
    'infinity-imperial-syner-d': `The Imperial Syner-D is built around a Flex-Track, Infinity's SL-plus-L hybrid that follows the spine from the neck down through the lumbar and then continues under the seat to reach the glutes and hamstrings. Paired with a 4D roller and AI body scanning, that extended path lets one chair handle upper-back tension and lower-body relief in the same session, instead of forcing the usual tradeoff between an S-track's shoulder focus and an L-track's lower reach. Its standout figure is fit: a confirmed 5'2" to 6'6" height range and a 300 lb capacity put it among the few chairs in the catalog that tall and plus-size buyers can size into with certainty rather than guesswork. It still reclines to within 2 inches of the wall, so the larger frame does not demand a larger room. Buyers cross-shopping Infinity's L-track models, the Evo Max 4D and Genesis Max 4D, are weighing the Flex-Track's full-spine coverage and confirmed tall fit against a more conventional L-track platform. The 5-year warranty is generous for this tier and adds confidence at the investment level.`,
    'human-touch-laevo-zg': `The Laevo ZG is the only vibration chair in our current catalog, and that distinction matters. For buyers who cannot tolerate roller pressure, including those with certain spinal conditions, injury recovery situations, or sensitivity to deep massage, it fills a gap no roller chair can. For everyone else seeking traditional massage chair benefits, a roller chair is the better choice.`,
    'luraco-i9-max-plus': `The Luraco i9 Max Plus is the only massage chair we know of that is manufactured in the United States. It is not inexpensive, but the 10-year warranty, the confirmed height range to 6'10", and the domestic manufacturing track record make it a serious option for buyers who prioritize longevity and service access over headline features.`,
    'synca-jp970': `The JP970 brings a 4D roller to its price tier, which is relatively uncommon. Track type is unconfirmed in our research. Verify directly with Synca before purchasing if your pain is specifically in the lower back and hips.`,
    'synca-jp1100': `The JP1100 adds zero gravity and heat to the JP970's 4D roller platform. Same caveat applies on track type: confirm with the retailer before purchasing if lower back or hip coverage is your primary concern.`,
    'daiwa-legacy-4': `The Daiwa Legacy 4 is notable for its confirmed 6'6" height accommodation and L-track coverage with a 3D roller. For buyers who are tall, have lower back and hip pain, and want a premium L-track option, it is worth a close look.`,
    'kyota-genki-m380': `The Kyota Genki M380 is a high-capacity L-track value pick, confirmed for buyers up to 6'5" and 330 lbs, in the entry tier (Under $3,000). Track type is unconfirmed. Verify with the retailer before purchasing based on pain location.`,
    'amamedics-hilux-4d': `The AmaMedics Hilux 4D has one distinctive feature: the rollers themselves are heated, not just the lumbar pad. This is uncommon and creates a noticeably different massage experience. The heat penetrates with the massage rather than sitting adjacent to it. The 4D L-track with 53" track length adds strong lower-body coverage.`,
    'amamedics-renew-3d': `The AmaMedics Renew 3D is a clearance model. Worth considering if you want a 3D roller at the lowest possible entry price and understand you are buying end-of-run inventory. Track type is unconfirmed.`,
    'ogawa-master-drive-le': `The Ogawa Master Drive LE 4D has confirmed SL-track coverage, height range of 5'2" to 6'1", and a 320 lb weight capacity. What makes it unusual is the dual-track mechanism: a 4D roller works the upper back while a separate 3D mechanism targets the glutes simultaneously. It is well-positioned for buyers who want comprehensive SL-track coverage with simultaneous upper and lower body massage.`,
    'ogawa-master-drive-ai': `The Master Drive AI 2.0 builds on the LE's dual-track SL platform with AI body scanning, Alexa voice control, and a second stage of zero gravity recline. The premium over the LE is meaningful. If you use voice control regularly and want the chair to adapt its pressure mapping session-by-session, the AI earns its cost. If those features are incidental, the LE delivers the same core track and roller experience for less.`,
    ...
    'jpmedics-kumo-4d': `The JPMedics Kumo 4D is made in Japan and holds a strong reputation among buyers who have done serious research. The 4D L-track covers the lower back and hips, and the Japanese manufacturing track record speaks to build quality and long-term reliability.`,
    'jpmedics-kaze-duo': `The JPMedics KaZe Duo uses a dual 4D roller mechanism. Track type is unconfirmed, verify before purchasing. The dual-roller configuration is for buyers who want maximum coverage density.`,
    'panasonic-mak1': `The Panasonic MAK1 is the most expensive S-track in the catalog. This is worth saying clearly: if your primary pain is in the lower back or hips, the track configuration will not reach those areas regardless of the price. For buyers focused on neck, shoulder, and upper-back relief who want the most refined S-track experience available, the MAK1's 4D rollers, infrared heat, and Panasonic's engineering depth make it exceptional in that specific context.`,
    'titan-3d-prestige': `The Titan 3D Prestige brings a confirmed SL-track and 3D roller with foot rollers and zero gravity. Titan is a well-established value brand, you are trading some premium finish for solid core specifications at a lower price than equivalent spec chairs from Osaki or Infinity.`,
  }
  return verdicts[chair.id] || `The ${chair.name} offers ${chair.track ? getTrackLabel(chair) : 'massage'} coverage${chair.roller ? ` via a ${chair.roller} roller` : ''}. For buyers matching the specification profile, it is worth a close look as part of your research.`
}
    ...
    <div className={outerClass}>
      ...
      <div className="flex flex-col gap-3">
        {alts.map(alt => (
          <div
            key={alt.id}
            className="flex items-center justify-between gap-4 bg-white rounded-lg p-4 border border-sand"
          >
            <div className="min-w-0">
              <p className="text-xs font-medium text-warm-gray uppercase tracking-wide mb-0.5">
                {alt.brand}
              </p>
            ...
            {resolveAffiliateUrl(alt) ? (
              ...
              <Link
                href={'/chairs/' + alt.id}
                className="shrink-0 text-sm py-2 px-4 rounded border border-gold text-gold font-semibold hover:bg-gold hover:text-white transition-colors"
              >
                View Details
              </Link>
            )}
...
export default async function ChairPage({ params }: { params: { slug: string } }) {
  ...
  // Resolve alternative chairs for OOS/discontinued panels
  const alternatives: Chair[] = (c.alternativeIds || [])
    .map(id => CHAIRS.find(ch => ch.id === id))
    .filter((ch): ch is Chair => !!ch)
  ...
  const availability = isDiscontinued || isOOS
  ...
  return (
    <>
      ...
      <div className="section max-w-5xl">
        ...
        {/* Discontinued notice + alternatives (top of page) */}
        {isDiscontinued && (
          <>
            <div className="mb-6 flex items-start gap-3 rounded-lg border border-terra/40 bg-terra/5 px-5 py-4">
              <span className="text-terra font-bold text-lg leading-none mt-0.5">&#9888;</span>
              <div>
                <p className="font-semibold text-terra">Chair Discontinued</p>
                <p className="text-sm text-charcoal mt-1">
                  This model is no longer in production. The page and specs below are preserved for research.
                  See the alternatives below to find the closest available chair today.
                </p>
              </div>
            </div>
            <AlternativesPanel
              alts={alternatives}
              title="Still available alternatives"
              body="These chairs share the closest combination of track type, roller, and price to the discontinued model."
            />
          </>
        )}
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {isDiscontinued && (
                  <span className="text-xs font-semibold px-3 py-1 rounded-full border border-terra text-terra bg-white">
                    Discontinued
                  </span>
                )}
                {isOOS && (
        ...
        {/* Quick take */}
        <div className="mb-12 max-w-2xl rounded-lg px-6 py-5" style={{ background: 'rgba(209,128,62,0.06)', border: '1px solid rgba(209,128,62,0.25)' }}>
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  ['User Height Range', (c.heightMinIn && c.heightMaxIn) ? Math.floor(c.heightMinIn/12)+"'"+c.heightMinIn%12+'" to '+Math.floor(c.heightMaxIn/12)+"'"+c.heightMaxIn%12+'"' : c.heightMaxIn ? 'Up to '+Math.floor(c.heightMaxIn/12)+"'"+c.heightMaxIn%12+'"' : null],
        ...
        <div className="bg-sand rounded-xl p-6 mb-8 max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link href="/buyers-guide" className="text-center py-2 px-5 rounded text-sm font-semibold border border-gold text-gold hover:bg-gold hover:text-white transition-colors">
              Buyer&apos;s Guide
            </Link>
