...
function verdictSummary(chair: Chair): string {
  const verdicts: Record<string, string> = {
    ...
    'kyota-genki-m380': `The Kyota Genki M380 is a high-capacity L-track pick, confirmed for buyers up to 6'5" and 330 lbs, whose price has moved between the entry and upper-mid tiers with retailer promotions through 2026; check the current band badge above. Track type is unconfirmed. Verify with the retailer before purchasing based on pain location.`,
