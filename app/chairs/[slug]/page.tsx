...
function verdictSummary(chair: Chair): string {
  const verdicts: Record<string, string> = {
    ...
    'osaki-os-pro-4d-duomax': `The DuoMax uses a dual 4D roller mechanism, using two independent roller sets running simultaneously, which is rare in this category. At $12,999 it is a premium investment, best suited for buyers who have already owned a quality massage chair and are looking for something significantly more capable. White glove delivery is included.`,
    ...
    'ogawa-master-drive-le': `The Ogawa Master Drive LE 4D has confirmed SL-track coverage, height range of 5'2" to 6'1", and a 320 lb weight capacity. What makes it unusual is the dual-track mechanism: a 4D roller works the upper back while a separate 3D mechanism targets the glutes simultaneously. At $9,399 it is well-positioned for buyers who want comprehensive SL-track coverage with simultaneous upper and lower body massage.`,
    'ogawa-master-drive-ai': `The Master Drive AI 2.0 builds on the LE's dual-track SL platform with AI body scanning, Alexa voice control, and a second stage of zero gravity recline. At $12,999 the premium over the LE is meaningful. If you use voice control regularly and want the chair to adapt its pressure mapping session-by-session, the AI earns its cost. If those features are incidental, the LE at $9,399 delivers the same core track and roller experience for less.`,
