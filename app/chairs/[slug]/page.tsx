...
function verdictSummary(chair: Chair): string {
  const verdicts: Record<string, string> = {
    ...
    'bodyfriend-phantom-ii': `The Phantom II brings Bodyfriend's 4D roller and zero gravity to this price tier. Track type is unconfirmed. Verify before purchasing if lower back and hip relief is your primary goal.`,
    'bodyfriend-palace-ii': `The Palace II offers a confirmed SL-track with 4D roller and zero gravity. The SL-track confirmation is meaningful: it means neck-to-glute coverage is verified, not estimated.`,
    'bodyfriend-falcon-xd': `The Falcon XD 4D is available via Amazon. Track type is unconfirmed. We recommend verifying coverage before purchasing based on pain location.`,
