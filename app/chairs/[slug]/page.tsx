...
function verdictSummary(chair: Chair): string {
  const verdicts: Record<string, string> = {
    ...
    'kyota-genki-m380': `The Kyota Genki M380 is a high-capacity L-track pick, confirmed for buyers up to 6'5" and 330 lbs, now in the upper-mid tier ($5,000-$7,999) after its long-running entry-tier promotion ended. Track type is unconfirmed. Verify with the retailer before purchasing based on pain location.`,
